...
public abstract class PCloudMultipartUpload extends MultipartUpload {
	...
	public PCloudMultipartUpload(String containerName, long folderId, String blobName, String id, BlobMetadata blobMetadata,
	 ...
	 * @return
	 */
	public abstract MultipartPart append(int partNumber, Payload payload) throws IOException;
	...
	public String toString() {
		return "PCloudMultipartUpload with id " + id + " [containerName=" + containerName + ", blobName=" + blobName + ", folderId=" + folderId + "]";
	}
}
